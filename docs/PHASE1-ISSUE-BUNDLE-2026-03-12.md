# Phase 1 Issue バンドル — 2026 年 3 月 12 日

## ステータス

これらの Issue ドラフトは 3 月 11 日メガプランと 3 月 12 日引き継ぎから準備された。GitHub で直接 Issue を開こうとしたが、MCP セッションでの GitHub 認証欠如のためブロックされた。

## GitHub ステータス

これらドラフトは後に `gh` 経由で投稿された:
...
以下の本文は、Issue 作成に使用したローカルソースバンドルとして保持される。
