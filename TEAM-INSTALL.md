...
```
/plugin marketplace add https://github.com/ishii-code/spm-medical-pack
...
```bash
# 任意の場所にクローン
git clone git@github.com:ishii-code/spm-medical-pack.git ~/spm-medical-pack
...
最新版確認：`/plugin list` のバージョン番号、または [GitHub Releases](https://github.com/ishii-code/spm-medical-pack/releases)。
...
- バグ報告・機能要望: [GitHub Issues](https://github.com/ishii-code/spm-medical-pack/issues)
